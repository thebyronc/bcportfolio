    ...
    <div className="rounded-lg bg-zinc-800 p-4 sm:p-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          {!state.isTipAmountMode ? (
            <>
              <div className="w-fit max-w-full overflow-hidden rounded-lg border border-zinc-600">
                  ...
                  <div className="inline-flex whitespace-nowrap">
                    {[0, 15, 18, 20].map((percent, idx) => (
                      <button
                        ...
                        className={`border px-4 py-2 font-semibold uppercase transition-colors ${
                          state.tipPercentage === percent && !showCustomInput
                            ? "text-volt-400 border-zinc-800 bg-zinc-800"
                            : "border-zinc-900 bg-zinc-900 text-zinc-300 hover:border-zinc-800 hover:bg-zinc-800"
                        } ${idx === 0 ? "rounded-l-lg" : ""} `}
                      >
                        {percent}%
                      </button>
                    ...
                    <button
                      ...
                      className={`rounded-r-lg border px-4 py-2 font-semibold uppercase transition-colors ${
                        showCustomInput
                          ? "text-volt-400 border-zinc-800 bg-zinc-800"
                          : "border-zinc-900 bg-zinc-900 text-zinc-300 hover:border-zinc-800 hover:bg-zinc-800"
                      } `}
              ...
              {showCustomInput && (
                <div className="mt-2 flex items-center gap-2">
                  <input
                    ...
                    className="w-24 rounded-lg border border-zinc-600 bg-zinc-700 px-3 py-2 text-center text-white"
                    placeholder="0.0"
                  />
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-32 rounded-lg border border-zinc-600 bg-zinc-700 px-3 py-2 text-center text-white"
                placeholder="0"
              />
            </div>
          )}
