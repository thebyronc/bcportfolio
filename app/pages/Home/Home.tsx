...
export default function Home() {
    ...
    return (
        <div className="relative">
            ...
            {/* Dark mode spotlight */}
            <div 
                className="spotlight-bg fixed inset-0 pointer-events-none z-0 block"
                style={{
            ...
            <div 
                className="spotlight-bg fixed inset-0 pointer-events-none z-0 hidden"
                style={{
                            ...
                            <a 
                                ...
                                className={`transition-colors text-lg flex items-center gap-2 ${
                                    activeSection === 'about' 
                                        ...
                                        : 'text-zinc-400 hover:text-volt-400'
                                }`}
                            >
