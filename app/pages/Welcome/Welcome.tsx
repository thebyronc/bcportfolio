import RandomQuestion from "~/routes/randomQuestion";
            ...
            <nav className="space-y-4 rounded-3xl border border-gray-200 p-6 dark:border-gray-700">
              ...
              <section className="mt-8">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Specializing in Front-End Development, Automation, and
                  Scalable Architectures. I thrive in complex and ambiguous
                  environments, taking initiative to optimize workflows,
                  innovate solutions, and deliver high-impact results. Adept at
                  developing modular React applications, optimizing developer
                  workflows, and mentoring teammates to deliver cohesive,
                  high-performance products. Known for streamlining CI/CD
                  pipelines, automating legacy processes, and collaborating
                  across UX, backend, and QA teams in Agile environments. I care
                  deeply about the developer experience by crafting intuitive
                  workflows and tooling that remove friction so developers can
                  ...
                  <div>
                    ...
                    <ul className="mt-2 list-inside list-disc space-y-1 text-gray-600 dark:text-gray-300">
                      ...
                      <li>
                        ...
                        PowerShell, Bash, and Node.js, reducing errors and
                        freeing up valuable team resources.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        structures into an easy to search and easy to maintain
                        web based training and documentation repository.
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="mt-2 list-inside list-disc space-y-1 text-gray-600 dark:text-gray-300">
                      ...
                      <li>
                        Standardized site migration processes with
                        .bash_profiles, Git pipelines, SSL certificates, and
